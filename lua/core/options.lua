...
vim.opt.cursorlineopt = 'number,screenline' --  number, screenline' -- can be 'line','screenline','number'
...
vim.opt.winbar =
"%{%v:lua.require'nvim-navic'.get_location()%}" -- always show the sign column, otherwise it would shift the text each time
