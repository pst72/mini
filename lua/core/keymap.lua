return
{
    vim.keymap.set({ 'v', 'n', 's' }, 'sw', '<cmd>Telescope grep_string pattern="<cword>"<cr>',
    ...
    vim.keymap.set('v', '<leader>hs',
        ...
        { desc = 'Stage hunk (selected)' }),
    vim.keymap.set('v', '<leader>hr',
        function() require('gitsigns').reset_hunk({ vim.fn.line('.'), vim.fn.line('v') }) end,
        { desc = 'Reset hunk (selected)' }),
    ...
    vim.keymap.set('n', '<leader>gC', function() require('telescope.builtin').git_commits() end,
        { desc = 'Git commits (current directory)' }),
    vim.keymap.set('v', '<leader>gC', function() require('telescope.builtin').git_bommits_range() end,
